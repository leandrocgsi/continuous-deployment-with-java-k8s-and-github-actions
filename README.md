# [Continuous Deployment with Java, GCP(Google Cloud Platform), Kubernetes and Github Actions](https://www.udemy.com/course/java-continuous-integration-continuous-delivery-aws-e-github-actions/?couponCode=LAUNCH_CDCD_JAVA)
### [Domine Continuous Deployment com Java, Spring Boot 3, Docker, Kubernetes, Github Actions, GCP, JUnit 5, Mockito, K8s e +](https://www.udemy.com/course/java-continuous-integration-continuous-delivery-aws-e-github-actions/?couponCode=LAUNCH_CDCD_JAVA)

[![Continuous Deployment with Github Actions](https://github.com/leandrocgsi/continuous-deployment-with-java-k8s-and-github-actions/actions/workflows/continuous-integration.yml/badge.svg)](https://github.com/leandrocgsi/continuous-deployment-with-java-k8s-and-github-actions/actions/workflows/continuous-integration.yml)
...
Este é o repositório dos codigos fonte desenvolvidos no curso [Continuous Deployment c Java GCP Kubernetes e Github Actions](https://www.udemy.com/course/java-continuous-integration-continuous-delivery-aws-e-github-actions/?couponCode=LAUNCH_CDCD_JAVA)
